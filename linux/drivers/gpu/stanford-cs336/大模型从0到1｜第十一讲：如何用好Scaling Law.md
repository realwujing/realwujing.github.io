...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_01.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_02.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_03.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_04.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_05.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_06.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_07.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_08.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_09.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_10.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_11.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_12.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_13.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_14.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_15.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_16.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_17.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_18.png)

### **Page 18: 鲁棒性 - 非线性激活**

* **结论:** 无论是 SwiGLU 还是 Squared ReLU，muP 都能保持最佳 LR 的稳定性。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_19.png)

### **Page 19: 鲁棒性 - Batch Size**

* **结论:** Batch Size 的变化不影响 muP 的 LR 迁移规律。虽然原始推导没考虑 Batch Size，但经验上是兼容的。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_20.png)

### **Page 20: 鲁棒性 - 初始化**

* **结论:** 使用 Zero Query Init（将 Query 初始化为 0）等技巧也不影响 muP。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_21.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_22.png)

### **Page 22: 不鲁棒 - 异构优化器 (Lion)**

* **现象:** Lion 优化器基于符号（Sign），不符合 muP 的假设。无法直接迁移。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_23.png)

### **Page 23: 不鲁棒 - 强权重衰减**

* **现象:** 当 Weight Decay 设为 0.1（现代标准）时，muP 失效。这是一个主要短板。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_24.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_25.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_26.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_27.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_28.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_29.png)

### **Page 29: 旁注 - 其他拟合方法**

* **内容:** 提到 Gadre et al 的工作。不仅看 Loss，还看“过拟合惩罚”。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_30.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_31.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_32.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_33.png)

### **Page 33: DeepSeek 的 Scaling 分析**

* **图表:** DeepSeek 在 7B 和 67B 模型发布时，也做了详尽的 Scaling 分析。验证了在小规模模型上拟合的规律可以准确预测大模型。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_34.png)

### **Page 34: DeepSeek 的性能验证**

* **表格:** DeepSeek 7B/67B 的跑分。性能与同级别的 Llama 2 相当或更好。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_35.png)

### **Page 35: 策略 - Batch Size + LR**

* **内容:** DeepSeek 采用了更传统的网格搜索策略来找最优 LR 和 Batch Size，而不是用 muP。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_36.png)

### **Page 36: 学习率 Scaling**

* **图表:** 右图展示了 Learning Rate 随 Compute 的变化。最佳 LR 似乎随着计算量增加而减小，但数据点有些噪声。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_37.png)

### **Page 37: 最佳 Batch Size**

* **图表:** 最佳 Batch Size 随着 Loss 降低（模型变强）而指数级增长。这符合 OpenAI 早期的结论。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_38.png)

### **Page 38: 最佳 Batch Size 曲线**

* **图表:** 将 Batch Size 与 Loss 进行拟合，得到一条干净的多项式曲线。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_39.png)

### **Page 39: 最佳 LR 稳定性**

* **图表:** 使用 muP 后，LR 随模型宽度变化的曲线变得平坦（Stable）。这再次验证了 muP 的作用。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_40.png)

### **Page 40: WSD 调度的细节**

* **图表:** 展示了 WSD 在不同模型上的 Loss 下降曲线。即使在训练很早期就开始 Decay，也能获得不错的收敛效果。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_41.png)

### **Page 41: 混合 WSD 策略**

* **内容:** DeepSeek 使用了 WSD 变体：快速 Warmup，然后保持 Stable，最后分阶段 Decay (80% + 10% + 10%)。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_42.png)

### **Page 42: IsoFLOP 分析 (DeepSeek)**

* **图表:** DeepSeek 复现了 Chinchilla 的 IsoFLOP 曲线（左图）和最优模型/数据扩展曲线（中/右图）。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_43.png)

### **Page 43: 预测最终 Loss**

* **图表:** 预测值与实际值的对比。Scaling Law 的预测精度非常高。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_44.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_45.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_46.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_47.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_48.png)
...
![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_49.png)

### **Page 49: muP 验证**

* **图表:** 再次展示了 muP 如何让 LR 调优变得 Scale-invariant。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_50.png)

### **Page 50: muP 的定义回顾**

* **内容:** 引用 muP 原论文的定义。A1 (Init) 和 A2 (Update) 条件。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_51.png)

### **Page 51: A1 条件推导**

* **数学:** 矩阵乘法的范数性质。$\|W h\| \approx \sqrt{n}$。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_52.png)

### **Page 52: A2 条件推导**

* **数学:** 梯度更新对输出的影响。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_53.png)

### **Page 53: A2 条件推导 (Part 2)**

* **数学:** 最终得出 LR $\eta = \Theta(1/n)$ 的结论。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_54.png)

### **Page 54: muP Recap**

* **总结:** muP 的核心就是控制 Activations 和 Updates 的规模。

![](scaling-laws2/2025%20Lecture%2011%20-%20Scaling%20details_55.png)
