...
- [<font color=Red>https://vault.centos.org/7.6.1810/os/Source/SPackages/>](https://vault.centos.org/7.6.1810/os/Source/SPackages/)
- [<font color=Red>CentOS上编译安装内核>](https://goodcommand.readthedocs.io/zh-cn/latest/os/CentOS_build_kernel.html)
