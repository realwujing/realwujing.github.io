...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HelloWidget_t, stringdata) + ofs \
...
const QMetaObject HelloWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HelloWidget.data,
      qt_meta_data_HelloWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HelloWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HelloWidget.stringdata))
        return static_cast<void*>(const_cast< HelloWidget*>(this));
