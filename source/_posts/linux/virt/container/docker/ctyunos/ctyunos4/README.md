---
title: 'CTYunOS 4 Docker 内核编译环境'
date: '2025/12/01 16:41:42'
updated: '2025/12/01 16:41:42'
---
...
```
ctyunos:4-25.07-250905           ← 基础 OS 镜像 (从 tar.xz 加载)
    ↓
ctyunos:4-25.07-250905-build     ← 安装 sudo、shadow-utils，创建用户
    ↓
ctyunos:4-25.07-250905-dev       ← 开发镜像 (运行时通过 --user 映射用户)
```
...
- CTYunOS 官方文档: https://repo.ctyun.cn/hostos/ctyunos-4/
