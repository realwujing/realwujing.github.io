...
- [Altium Designer 18](https://www.rjctx.com/15522.html)
- <https://www.altium.com/documentation/other_installers#libraries>
- [Altium Designer封装库：常用元件封装下载与使用 Altium Designer 10 Libraries AD官网上 ad10 版本的冷冻库](https://gofarlic.com/techArticleDetail?noticeId=398410)
- [Altium Designer 10 Libraries](linux/drivers/ad/Libraries.zip)

  切分：将 Libraries.zip 切割成每个 45MB 的分块，生成 Libraries.zip_00、Libraries.zip_01……
  ```bash
  split -b 45m -d -a 2 Libraries.zip Libraries.zip_
  ```

  合并：将所有分块按顺序拼接，还原为原始的 Libraries.zip:
  ```bash
  cat Libraries.zip_* > Libraries.zip
  ```
...
* **主链接**：`https://pan.baidu.com/s/1A6r17hnKQPdopciNG_b3Zg`
  - **提取码**：`x2a3`
- **备用链接**：`https://pan.baidu.com/s/1eMJSo1lB80xlVRrs9aMJgw`
  - **提取码**：`m4hs`
