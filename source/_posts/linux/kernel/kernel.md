...
- [Linux内核新特性深度解读](https://www.sysgeek.cn/linux/linux-kernel/)
- [<font color=Red>This is a list of links to every changelog.</font>](https://kernelnewbies.org/LinuxVersions)
