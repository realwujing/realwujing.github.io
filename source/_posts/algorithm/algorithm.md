---
date: 2023/04/21 10:59:07
updated: 2025/06/18 16:57:18
---
...
- [算法入门教程（多语言实现）](https://c.biancheng.net/algorithm_tutorial/)
...
- [一分钟带你读懂什么是堆？ - 码农田小齐 - 博客园 (cnblogs.com)](https://www.cnblogs.com/nycsde/p/13772560.html)
- [操作系统中堆和栈的区别_SpeedMe的博客-CSDN博客](https://blog.csdn.net/speedme/article/details/22943191/)

## 遍历

- [二叉树前序遍历、中序遍历、后序遍历、层序遍历的直观理解_白夜行的狼-CSDN博客_中序遍历](https://blog.csdn.net/u013834525/article/details/80421684)
- [二叉树遍历(先序、中序、后序) - 简书 (jianshu.com)](https://www.jianshu.com/p/456af5480cee)
- [<font color=Red>二叉树遍历（前序、中序、后序、层次遍历、深度优先、广度优先）</font>](https://blog.csdn.net/My_Jobs/article/details/43451187)
- [DFS（深度优先搜索）和BFS(广度优先搜索)](https://www.jianshu.com/p/b086986969e6)
...
- [图解一致性哈希算法，看这一篇就够了](https://www.toutiao.com/article/7167302615553065511/)
- [一致性哈希算法设计题，栽了](https://mp.weixin.qq.com/s/zL-n7zq0Zyhf-l_GQil2dg)
