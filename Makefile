...
#	echo "$(KERNELVERSION)$$($(CONFIG_SHELL) $(srctree)/scripts/setlocalversion $(srctree))"
	echo "$(CONFIG_BUILD_SALT)$$($(CONFIG_SHELL) $(srctree)/scripts/setlocalversion $(srctree))"
endef
...
_modinst_:
	...
	$(Q)if [ -f $(srctree)/scripts/uos/modulecheck/modulecheck.sh ]; then \
		echo $(shell $(objtree)/scripts/uos/modulecheck/modulecheck.sh) > /dev/null; \
	fi;
...
CLEAN_FILES += $(srctree)/debian/api-tmp.json
